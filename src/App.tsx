    ...
    <section id="top" className="relative pt-40 pb-28 lg:pt-52 lg:pb-40 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-6">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl leading-[1.02] text-ink">
            Edifique
            <br />
        ...
        <div className="lg:col-span-6">
          <div className="relative aspect-[4/5] lg:aspect-[5/6] rounded-2xl overflow-hidden shadow-[var(--shadow-elevate)]">
            <img
              src={heroImg}
    ...
    <section id="contato" className="py-28 lg:py-36 bg-ice border-y border-border">
      <div className="mx-auto max-w-5xl px-6 lg:px-10 text-center">
        ...
        <h2 className="text-4xl md:text-6xl leading-[1.05]">
          ...
          <br />
          <span className="text-primary">com uma conversa.</span>
        </h2>
        <p className="mt-6 text-foreground/80 text-lg max-w-2xl mx-auto">
